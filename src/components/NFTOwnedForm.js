...
class NFTOwnedForm extends Component {
  constructor(props) {
    super(props)
      ...
      <form className="mb-3" onSubmit={(event) => {
        ...
        <div style={{
          ...
          alignItems: "center"
              ...
              <NFTMpCard nftImageUri = {this.state.uriOwned} nftImageName = {this.state.idOwned}  nftMintAddress = {this.state.nftMintAddress}/>
          </div>
        <div>

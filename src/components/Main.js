...
class Main extends Component {
  ...
  render() {
    ...
    */
    //<button type="submit" className="butInline btn color-butTab" > Claim Rewards</button> 
    //<button type="submit" className="butInline btn color-butTab"> Re-Compound</button> 
    /*
    <a><button
              className="btn btn-outline-dark"
              onClick={(event) => {

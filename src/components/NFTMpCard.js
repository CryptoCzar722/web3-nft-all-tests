...
class NFTMpCard extends Component {
            ...
            <div className='card'>
                <div className='card-content'>
                    ...
                    <div className='card-content_user-name' style ={{overflow: "hidden"}}>
                        <p>
                         Contract : <span href = "https://testnet.bscscan.com/address/0x96C742592c5b55C17c86B6a996c91C8A812BB91C" > {this.props.nftMintAddress} </span>
                        </p>
                    </div>
                    </div>
            </div>
